...
* **🔄 Sistema de Update Obrigatório:** Garante que você sempre utilize a versão mais estável e segura.
* **👤 Perfil Personalizado:** Sistema de login e registro para gerenciar sua biblioteca e tempo de membro.
* **🖥️ Suporte Windows 11/10:** Otimizado para rodar perfeitamente na versão mais recente do sistema.
